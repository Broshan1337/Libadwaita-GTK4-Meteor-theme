...
public class WAdwaitaConfirmedButton extends WConfirmedButton implements AdwaitaWidget {

    public WAdwaitaConfirmedButton(String text, String confirmText, GuiTexture texture) {
