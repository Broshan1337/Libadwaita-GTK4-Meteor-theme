package me.pindour.adwaita.gui.themes.adwaita.widgets.settings;
...
import me.pindour.adwaita.gui.themes.adwaita.widgets.input.WAdwaitaTextBox;
import me.pindour.adwaita.utils.ColorUtils;
import me.pindour.adwaita.utils.WidgetUtils;
...
//? if <=1.21.10
//import me.pindour.adwaita.mixin.meteorclient.WSliderAccessor;

import java.math.BigDecimal;
import java.math.RoundingMode;

public class WAdwaitaDoubleEdit extends WVerticalList implements AdwaitaWidget {
    ...
    private WAdwaitaTextBox textBox;
    private WSlider slider;

    public WAdwaitaDoubleEdit(DoubleSetting setting) {
        this(setting.title,
            setting.description,
            setting,
            setting.get(),
    ...
    public WAdwaitaDoubleEdit(String title, String description, DoubleSetting setting, double value, double min, double max, int decimalPlaces, double sliderMin, double sliderMax, boolean noSlider) {
        this.title = title;
    ...
    public void init() {
        ...
        // Value
        textBox = (WAdwaitaTextBox) list.add(theme().textBox(valueString(), this::filter, 0)).expandX().expandCellX().widget();
    ...
    public boolean showReset() {
        return mouseOver || (slider != null
                ...
                && slider.focused
                //? } else {
                /*&& ((WSliderAccessor) slider).adwaita$isHandleMouseOver()
                *///? }
        );
    }
}
