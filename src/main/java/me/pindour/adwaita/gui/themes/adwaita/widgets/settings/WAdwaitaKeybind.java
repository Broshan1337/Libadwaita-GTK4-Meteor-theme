...
public class WAdwaitaKeybind extends WKeybind implements AdwaitaWidget {
    public Runnable action;
    public Runnable actionOnSet;

    private WAdwaitaButton button;
    ...
    public WAdwaitaKeybind(String title, Keybind keybind, Keybind defaultValue) {
