...
public class WAdwaitaIntEdit extends WVerticalList implements AdwaitaWidget {
    ...
    public WAdwaitaIntEdit(IntSetting setting) {
    ...
    public void init() {
        ...
        // Value
        textBox = (WAdwaitaTextBox) list.add(theme().textBox(Integer.toString(value), this::filter, 0)).expandX().expandCellX().widget();
