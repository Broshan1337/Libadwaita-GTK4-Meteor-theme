...
public abstract class WMultiSelect<T> extends WVerticalList {
    ...
    private WAdwaitaCheckbox selectAllCheckbox;
    ...
    @Override
    public void init() {
        AdwaitaGuiTheme theme = (AdwaitaGuiTheme) getTheme();
        ...
        if (items.size() > 1) {
            ...
            selectAllCheckbox = (WAdwaitaCheckbox) list.add(theme.checkbox(false)).padLeft(8).widget();
    ...
    protected abstract class WHeader extends WHorizontalList {
        ...
        protected WAdwaitaLabel sizeLabel;
        ...
        public void init() {
            ...
            sizeLabel = (WAdwaitaLabel) add(theme.label(getSizeLabel())).padHorizontal(pad()).widget();
    ...
    protected class WItem extends WHorizontalList {
        ...
        protected WAdwaitaCheckbox checkbox;
        ...
        public void init() {
            ...
            checkbox = (WAdwaitaCheckbox) add(theme.checkbox(selected)).padLeft(8).widget();
