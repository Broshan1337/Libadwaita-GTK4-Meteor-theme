package me.pindour.adwaita.gui.screens.settings;
...
public class AdwaitaEntityTypeListSettingScreen extends WindowScreen {
    ...
    public AdwaitaEntityTypeListSettingScreen(AdwaitaGuiTheme theme, EntityTypeListSetting setting) {
