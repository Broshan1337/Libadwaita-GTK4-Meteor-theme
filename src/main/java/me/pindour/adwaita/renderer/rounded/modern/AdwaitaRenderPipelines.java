package me.pindour.adwaita.renderer.rounded.modern;
...
public class AdwaitaRenderPipelines {
    ...
    public static final RenderPipeline ROUNDED_UI = register(new ExtendedRenderPipelineBuilder(MESH_UNIFORMS)
        .withLocation(AdwaitaAddon.identifier("pipeline/rounded_ui"))
        .withVertexFormat(MeteorVertexFormats.POS2_TEXTURE_COLOR, VertexFormat.DrawMode.TRIANGLES)
        .withVertexShader(AdwaitaAddon.identifier("shaders/rounded_ui.vert"))
        .withFragmentShader(AdwaitaAddon.identifier("shaders/rounded_ui.frag"))
